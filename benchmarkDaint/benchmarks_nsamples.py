...
for n in ns:
    for i in range(0,len(cases)):
        c = cases[i] 
        xmlname = basedir+"benchmarkDaint/inputfiles_3d_3samples/benchmark_"+xmlcases[i]+"_"+n+".xml"
	jobname = xmlcases[i]+"_"+n+"_"+"3d_"+nnodes
	newfolder = "build_"+c+"_"+n+"_3d_"+nnodes
