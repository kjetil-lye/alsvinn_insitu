...
/cluster/home/hohlr/cmake-3.14.5/bin/cmake .. -DCMAKE_BUILD_TYPE=Release -DALSVINN_USE_CUDA=OFF -DALSVINN_BUILD_TESTS=OFF -DALSVINN_PYTHON_VERSION=2.7 -DALSVINN_BUILD_DOXYGEN=OFF -DBoost_NO_BOOST_CMAKE=ON -DCMAKE_PREFIX_PATH=/cluster/home/hohlr/boost/   -DALSVINN_BUILD_DOXYGEN=OFF -DALSVINN_USE_CUDA=OFF



/cluster/home/hohlr/cmake-3.14.5/bin/cmake ..
-DPARAVIEW_INSTALL_DEVELOPMENT_FILES=ON
-DPARAVIEW_ENABLE_PYTHON=ON -DVTK_PYTHON_VERSION=2 -DPARAVIEW_BUILD_QT_GUI=OFF -DPARAVIEW_USE_MPI=ON -DPARAVIEW_ENABLE_CATALYST=ON -DCMAKE_BUILD_TYPE=Release -DPARAVIEW_PYTHON_VERSION=2
...
/cluster/home/hohlr/cmake-3.14.5/bin/cmake .. -DPARAVIEW_INSTALL_DEVELOPMENT_FILES=ON -DPARAVIEW_ENABLE_PYTHON=ON -DVTK_PYTHON_VERSION=2 -DPARAVIEW_BUILD_QT_GUI=OFF -DPARAVIEW_USE_MPI=ON -DPARAVIEW_ENABLE_CATALYST=ON -DCMAKE_BUILD_TYPE=Release -DPARAVIEW_PYTHON_VERSION=2
...
make
 ...
 PARAVIEW_PYTHON_VERSION=2
  PARAVIEW_USE_MPI                 ON

 PARAVIEW_ENABLE_PYTHON           ON
 CMAKE_INSTALL_PREFIX             /cluster/home/hohlr/paraview
