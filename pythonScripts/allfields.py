  ...
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      coprocessor.RegisterView(renderView1,
          filename='rho_mean_%t.png', freq=1, fittoscreen=1, magnification=1, width=1061, height=869, cinema={})
      renderView1.ViewTime = datadescription.GetTime()

      # Create a new 'Render View'
      renderView2 = CreateView('RenderView')
      renderView2.ViewSize = [526, 869]
      renderView2.AxesGrid = 'GridAxes3DActor'
      renderView2.CenterOfRotation = [7.5, 7.5, 7.5]
      renderView2.StereoType = 0
      renderView2.CameraPosition = [-51.45323716080546, 9.892539977872293, -48.20182614491297]
      renderView2.CameraFocalPoint = [7.5, 7.5, 7.5]
      renderView2.CameraViewUp = [0.035737065241811576, 0.9993482058331584, 0.005101535646242673]
      ...
      coprocessor.RegisterView(renderView3,
          filename='rho_var_%t.png', freq=1, fittoscreen=1, magnification=1, width=1061, height=869, cinema={})
