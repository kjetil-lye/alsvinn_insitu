...
def getRGBPoints(vname):
  ...
  tablergb['mx_mean']=[-0.9939805574603099, 0.231373, 0.298039, 0.752941, -0.24172686634590224, 0.865003, 0.865003, 0.865003, 0.5105268247685054, 0.705882, 0.0156863, 0.14902]
...
def getPWFPoints(vname):
    ...
    tablepwf['mx_mean']=  [-0.9939805574603099, 0.0, 0.5, 0.0, 0.5105268247685054, 1.0, 0.5, 0.0]
      ...
      for ifield in range(0,len(fields)):
        ...
        #  grid = input.GetClientSideObject().GetOutputDataObject(0)
         ...
         # pixelw,pixelh = getImageSize(64,64,64)
          ...
          renderView1.CenterOfRotation = [256,256,256]
          renderView1.StereoType = 0
          renderView1.CameraPosition = [1500, 265, -925]
          renderView1.CameraFocalPoint = [256, 256, 256]
          ...
          coprocessor.RegisterView(renderView1,
              filename=fieldname+'_%t.png', freq=1, fittoscreen=0, magnification=1, width=pixelw, height=pixelh, cinema={})
