...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView1.CameraPosition = [-32.10165425207427, 21.86244145620717, 34.78669182999615]
      renderView1.CameraFocalPoint = [7.500000000000005, 7.500000000000005, 7.500000000000005]
      renderView1.CameraViewUp = [0.17845082075662183, 0.9534990456572595, -0.24288860512997237]
      ...
      rho_meanLUT.RGBPoints = [0.9877239458253932, 0.231373, 0.298039, 0.752941, 1.514264741690118, 0.865003, 0.865003, 0.865003, 2.040805537554843, 0.705882, 0.0156863, 0.14902]
      ...
      rho_meanPWF.Points = [0.9877239458253932, 0.0, 0.5, 0.0, 2.040805537554843, 1.0, 0.5, 0.0]
      rho_meanPWF.ScalarRangeInitialized = 1

      # trace defaults for the display properties.
      mergeBlocks1Display.Representation = 'Volume'
      mergeBlocks1Display.ColorArrayName = ['POINTS', 'rho_mean']
      mergeBlocks1Display.LookupTable = rho_meanLUT
      mergeBlocks1Display.OSPRayScaleArray = 'E_mean'
      mergeBlocks1Display.OSPRayScaleFunction = 'PiecewiseFunction'
      mergeBlocks1Display.SelectOrientationVectors = 'E_mean'
      mergeBlocks1Display.ScaleFactor = 1.5
      mergeBlocks1Display.SelectScaleArray = 'E_mean'
      mergeBlocks1Display.GlyphType = 'Arrow'
      mergeBlocks1Display.GlyphTableIndexArray = 'E_mean'
      mergeBlocks1Display.GaussianRadius = 0.075
      mergeBlocks1Display.SetScaleArray = ['POINTS', 'E_mean']
      mergeBlocks1Display.ScaleTransferFunction = 'PiecewiseFunction'
      mergeBlocks1Display.OpacityArray = ['POINTS', 'E_mean']
      ...
      mergeBlocks1Display.ScalarOpacityFunction = rho_meanPWF
      mergeBlocks1Display.ScalarOpacityUnitDistance = 1.772345424780136

      # init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
      mergeBlocks1Display.OSPRayScaleFunction.Points = [1.9984014443252818e-13, 0.0, 0.5, 0.0, 0.2761551785771892, 1.0, 0.5, 0.0]

      # init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
      mergeBlocks1Display.ScaleTransferFunction.Points = [1.9984014443252818e-13, 0.0, 0.5, 0.0, 0.2761551785771892, 1.0, 0.5, 0.0]

      # init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
      mergeBlocks1Display.OpacityTransferFunction.Points = [1.9984014443252818e-13, 0.0, 0.5, 0.0, 0.2761551785771892, 1.0, 0.5, 0.0]
