...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView1.CameraParallelScale = 10.606601717798213
      ...
      rho_meanLUT.RGBPoints = [0.9495096365153857, 0.231373, 0.298039, 0.752941, 1.5081537165111787, 0.865003, 0.865003, 0.865003, 2.0667977965069717, 0.705882, 0.0156863, 0.14902]
      ...
      rho_meanPWF.Points = [0.9495096365153857, 0.0, 0.5, 0.0, 2.0667977965069717, 1.0, 0.5, 0.0]
