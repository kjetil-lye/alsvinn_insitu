...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView1.CameraPosition = [481.2715487517842, 15.564949333276989, 124.75280725768269]
      renderView1.CameraFocalPoint = [63.49999999999995, 63.50000000000004, 63.50000000000003]
      renderView1.CameraViewUp = [0.12531915175787153, 0.9888116526716845, -0.08091122136873019]
      ...
      rho_meanLUT.RGBPoints = [0.9781127799084176, 0.231373, 0.298039, 0.752941, 1.5319980786641976, 0.865003, 0.865003, 0.865003, 2.085883377419978, 0.705882, 0.0156863, 0.14902]
      ...
      rho_meanPWF.Points = [0.9781127799084176, 0.0, 0.5, 0.0, 2.085883377419978, 1.0, 0.5, 0.0]
