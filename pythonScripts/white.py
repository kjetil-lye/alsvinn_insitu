...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView1.CenterOfRotation = [11.5, 11.5, 0.0]
      renderView1.StereoType = 0
      renderView1.CameraPosition = [11.5, 11.5, 10000.0]
      renderView1.CameraFocalPoint = [11.5, 11.5, 0.0]
      renderView1.CameraParallelScale = 13.440872700240158
      ...
      coprocessor.RegisterView(renderView1,
          filename='RenderView1_%t.png', freq=1, fittoscreen=1, magnification=1, width=1000, height=700, cinema={})
      renderView1.ViewTime = datadescription.GetTime()

      # Create a new 'Render View'
      renderView2 = CreateView('RenderView')
      renderView2.ViewSize = [1505, 709]
      ...
      renderView2.CenterOfRotation = [11.5, 11.5, 0.0]
      renderView2.StereoType = 0
      renderView2.CameraPosition = [11.5, 11.5, 51.93154427610262]
      renderView2.CameraFocalPoint = [11.5, 11.5, 0.0]
      renderView2.CameraParallelScale = 16.263455967290593
      ...
      rhoLUT.RGBPoints = [0.9201180394283577, 0.231373, 0.298039, 0.752941, 1.5237164821044185, 0.865003, 0.865003, 0.865003, 2.127314924780479, 0.705882, 0.0156863, 0.14902]
      rhoLUT.ScalarRangeInitialized = 1.0

      # get opacity transfer function/opacity map for 'rho'
      rhoPWF = GetOpacityTransferFunction('rho')
      rhoPWF.Points = [0.9201180394283577, 0.0, 0.5, 0.0, 2.127314924780479, 1.0, 0.5, 0.0]
      ...
      inputDisplay.ScalarOpacityUnitDistance = 4.021835252491098
      ...
      rhoLUTColorBar.Position = [0.773421926910299, 0.07757404795486603]
      ...
      rhoLUTColorBar.ScalarBarLength = 0.33000000000000007
      ...
      eLUT.RGBPoints = [5.370296084978112, 0.231373, 0.298039, 0.752941, 6.297688607148931, 0.865003, 0.865003, 0.865003, 7.225081129319751, 0.705882, 0.0156863, 0.14902]
      eLUT.ScalarRangeInitialized = 1.0

      # get opacity transfer function/opacity map for 'E'
      ePWF = GetOpacityTransferFunction('E')
      ePWF.Points = [5.370296084978112, 0.0, 0.5, 0.0, 7.225081129319751, 1.0, 0.5, 0.0]
      ...
      inputDisplay_1.ScalarOpacityUnitDistance = 4.021835252491098
      ...
      eLUTColorBar.Position = [0.7302325581395348, 0.08744710860366717]
      ...
      eLUTColorBar.ScalarBarLength = 0.3299999999999999
