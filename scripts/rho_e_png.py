  ...
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      coprocessor.RegisterView(renderView1,
          filename='rho_0_%t.png', freq=1, fittoscreen=0, magnification=1, width=1462, height=497, cinema={})
      renderView1.ViewTime = datadescription.GetTime()

      # Create a new 'Render View'
      renderView2 = CreateView('RenderView')
      renderView2.ViewSize = [1462, 497]
      ...
      coprocessor.RegisterView(renderView2,
          filename='e_1_%t.png', freq=1, fittoscreen=0, magnification=1, width=1462, height=497, cinema={})
